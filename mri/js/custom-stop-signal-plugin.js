...
jsPsych.plugins["custom-stop-signal-plugin"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    Tfix = jsPsych.totalTime(); // luc: added Tfix
    Tstim = null; // luc: initialize Tstim variable
    ...
    var end_trial = function() {
      ...
      var trial_data = {
        ...
        "Tfix": Tfix, // luc: added Tfix
        "Tstim": Tstim, // luc, added Tstim
